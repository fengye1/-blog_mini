...
from . import main
from ..modles import Article,BlogView,Source,ArticleType,User, Comment,Follow
...
@main.route('/article-source/<int:id>')
def article_sources(id):
    ...
    articles = pagination.items
    return render_template('index.html',articles=articles,
                           pagination=pagination, endpoint='.article_sources',id=0)

@main.route('/article_types/<int:id>')
def article_type(id):
    BlogView.add_view(db)
    page = request.args.get('page', 1 ,type=int)
    ...
    articles = pagination.items
    return render_template('index.html', articles=articles,
                           pagination=pagination, endpoint='.article_type',id=id)
